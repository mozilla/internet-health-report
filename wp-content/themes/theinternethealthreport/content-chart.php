...
<div class="data <?php if ($type == 'donut js-donut') { echo 'data--donut'; } ?>">
  ...
  <div class="data__footer">
    <div class="data__share">
      <a href="<?php echo get_facebook_share_url($page_permalink_str . '#' . $chart_id); ?>" target="_blank" class="data__link js-social-share"><?php get_template_part('assets/icons/icon', 'facebook.svg'); ?> <span class="data__link-text"><?php echo $facebookShareText; ?></span></a>
      <a href="<?php echo get_twitter_share_url($page_permalink_str . '#' . $chart_id, get_the_title($ID)); ?>" target="_blank" class="data__link js-social-share"><?php get_template_part('assets/icons/icon', 'twitter.svg'); ?> <span class="data__link-text"><?php echo $twitterShareText; ?></span></a>
